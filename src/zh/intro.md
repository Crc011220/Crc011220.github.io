...
- 邮箱: [ruocchen1220@163.com](mailto:ruocchen1220@163.com)
- 电话: +86 13738337771
- 位置: 上海
...
## 技能
- **编程语言**: Java, Python, JavaScript, TypeScript, SQL, C#, Shell, Lua, R, Haskell, Prolog
- **框架**: Spring Boot, Spring Cloud, Django, MyBatis, Node.js, Express.js, Vue, React, Next.js, WordPress
- **数据库**: MySQL, PostgreSQL, Redis, Elasticsearch, MongoDB
- **消息队列**: RabbitMQ, Kafka
- **开发工具**: Git, Docker, Kubernetes, Linux, Postman, Maven, JMeter, Swagger, Selenium
...
- 定时任务调度系统（Spring Boot + Spring Security + MyBatis Plus + Redis + React）
  ...
  - 构建自动化质量保障流程，集成 Git Hooks 预提交验证 + GitHub Actions 持续集成，结合 JUnit 5 单元测试框架确保代码质量与系统稳定性。
...
- 基于Ruoyi实现了前后台功能，包括节点管理、设备管理、产品管理和工单管理、运营管理、设备屏幕接口和订单管理。
...
- **工具**: AWS, SalesForce, Figma, Xmind, Draw.io, Trello
