...
![多分类任务损失函数](./mutlclassification-lossfunction.png)
...
![二分类任务损失函数](./binaryclassification-lossfunction.png)
...
![梯度下降优化方法选择](./gradient-op-summary.png)

## 学习率衰减优化方法

###  为什么进行学习率优化

- 学习率过高，会造成loss震荡，甚至爆炸，无法收敛。学习率过低，会造成模型收敛速度慢，甚至无法收敛。
